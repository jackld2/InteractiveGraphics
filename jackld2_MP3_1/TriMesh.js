    ...
    */
    loadFromOBJ(fileText)
    {
        ...
        for (var i=0; i < linearray.length; i++) {
            s = linearray[i].split(" ");
            if(linearray[i][0] == "f") {
                this.fBuffer.push(parseInt(s[2]) - 1);
                this.fBuffer.push(parseInt(s[3]) - 1);
                this.fBuffer.push(parseInt(s[4]) - 1);
                this.numFaces++;
            }
            if(linearray[i][0] == "v") {
                this.vBuffer.push(parseFloat(s[1]));
                this.vBuffer.push(parseFloat(s[2]));
                this.vBuffer.push(parseFloat(s[3]));
                this.numVertices++;
            }
            if(linearray[i][0] == "#") {
        ...
        //----------------
        console.log("TEST", this.numVertices);
...
//        gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(this.texcoordBuffer),
//                gl.STATIC_DRAW); 
